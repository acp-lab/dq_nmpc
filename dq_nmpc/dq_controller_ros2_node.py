...
def solver(params, flag = True):
    print("Creating a ROS2 Node automatically Using Acados")
    # get dynamical model
    ...
    # Cost Function
    path_cost = ln_error.T@Q_dual@ln_error + error_u.T@R_u@error_u + error_v.T@Q_v@error_v + error_w.T@Q_w@error_w
    terminal_cost = ln_error.T@Q_dual@ln_error + error_v.T@Q_v@error_v + error_w.T@Q_w@error_w
    ocp.model.cost_expr_ext_cost_0 = path_cost
    ocp.model.cost_expr_ext_cost = path_cost
    ...
    cost_params = np.array([210., 210., 210., 300., 1., 1., 1., 5., 5., 5., 5., 1., 1., 1., 210., 210., 210., 300., 1., 1., 1., 5., 5., 5., 5., 1., 1., 1., 0.5, 0.1, 0.1, 0.1])
    ...
    ocp.ros_opts.package_name = model.name
