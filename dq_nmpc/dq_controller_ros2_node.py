...
def solver(params, flag=True):
    ...
    ocp.solver_options.cg_hardcode_constraints = (
        False  # Allow runtime constraint changes
    )
    ocp.solver_options.cg_use_variable_weighting_matrix = (
        True  # Support time-varying costs
    )
