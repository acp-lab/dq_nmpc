...
class Quaternion:
    ...
    def __mul__(self, q2: "Quaternion") -> "Quaternion":
        ...
        if isinstance(q2, Quaternion):
            ...
            raise TypeError(
                "Left Multiplication is only defined for Quaternions and scalars"
            )
    ...
    def __rmul__(self, q2) -> "Quaternion":
        ...
        if isinstance(q2, Number):
            ...
            if q2.shape[0] == 1:
                ...
                raise TypeError(
                    "Right Multiplication is only defined for scalars of the same type"
                )
    ...
    def product(p: Vector, q: Vector) -> Vector:
        ...
        if isinstance(p, np.ndarray) and isinstance(
            ...
            raise TypeError(
                "The elements of both quaternions should be of the same type."
            )
    ...
    def ln(self):
        ...
        if isinstance(q, np.ndarray):  # Use Vector directly without parentheses
            ...
            result = np.vstack(
                (0.0, (1 / 2) * angle * x, (1 / 2) * angle * y, (1 / 2) * angle * z)
            )
